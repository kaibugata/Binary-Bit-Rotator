...
HD_PWD='C:/Users/Kailan/Documents/Vivado Projects/Binary Bit Shift Project/Binary Bit Shift Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bitshift.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bitshift.tcl -notrace
